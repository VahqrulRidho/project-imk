                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Judul</strong>
                                    <input type="text" name="judul" value="{{ $struktur->judul }}" class="form-control"
                                        placeholder="Input Judul" required>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Foto Struktur</strong>
                                    <input type="file" class="form-control form-control-md" name="foto"
                                        value="{{ $struktur->foto }}" placeholder="Foto Struktur" />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 text-right mb-3">
                                <a class="btn btn-dark" href="{{ route('struktur') }}"> Back</a>
